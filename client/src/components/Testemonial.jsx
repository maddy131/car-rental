...
const Testemonial = () => {
    const testimonials = [
        ...
        { name: "Ava Johnson", location: "Sydney, Australia", image: assets.testimonial_image_3,  testimonial: "I highly recommend CarRental! Their fleet is amazing, and I always feel like I'm getting the best deal with execelent service" }
        
    ];
  return (
    <div 
    className='py-28 px-6 md:px-16 lg:px-24 xl:px-44'>
        <Title title='What Our Customers Say' subTitle="Discover why discerning travelers choose StayVenture for their luxary accomodations around the world."/>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
                {testimonials.map((testimonial, index) => (
                    <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.2,ease:'easeOut' }} viewport={{ once: true , amount: 0.3 }}
