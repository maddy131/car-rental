...
const AddCar = () => {
  ...
  const {axios, currency, fetchCar} = useAppContext()
        ...
        <div className='flex items-center gap-2 w-full'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='flex flex-col w-full'>
              ...
              <input type="number" placeholder='e.g. 2,3,4 ... ' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={e=> setCar({...car, seating_capacity: e.target.value})}/>
            </div>
          </div>
