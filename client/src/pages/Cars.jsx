...
const Cars = () => {
  ...
  const searchCarAvailability = async()=>{
    const {data} = await axios.get('/api/bookings/check-availability',{location: pickupLocation, startDate: pickupDate, endDate: returnDate})
    if(data.success){
  ...
  return (
    <div>
      ...
      className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title title='Available Cars' subTitle='Browse our selection of premium vehicles available for you next addventure'/>
